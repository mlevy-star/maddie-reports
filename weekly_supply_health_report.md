...
For each page type compute:
  ...
  - DFL direction: is sessions_with_widget_display up or down WoW and vs 30d?
...
Also report ad_ops session count for prior vs current vs 30d to determine spend-side vs volume-side.
...
_[One line DFL summary — e.g. "DFLs up across all pages (+14.7% TYP WoW, +8.2% vs 30d) — confirmed demand-side"
or "DFLs down (TYP −18% WoW, −12% vs 30d) — supply-side contraction"]_
